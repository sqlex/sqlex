...
object SqlExIcons {
    ...
    @JvmField
    val IconX12 = IconUtil.resizeSquared(Icon, 12) //Editor gutter

    @JvmField
    val IconX13 = IconUtil.resizeSquared(Icon, 13) //Tool window

    @JvmField
    val IconX16 = IconUtil.resizeSquared(Icon, 16) //Node,Action,Filetype
